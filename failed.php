...
$sql = mysqli_query($db, "SELECT * FROM `grade` INNER JOIN `candidate` on grade.candidate_nation_id = candidate.candidate_nation_id WHERE grade.decision='Failed'");
$tbody = '';
        ...
        <div class="container">
            <div class="nav-wrapper">
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="./failed.php" class="active">Failed</a></li>
